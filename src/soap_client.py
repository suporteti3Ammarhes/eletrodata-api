...
class SOAPClient:
    ...
    def __init__(self, url: str, headers: dict, sistema: str):
        self.url = url
    ...
    def executar(self, consulta, parametros: str):
        ...
        return self._processar_resposta(response.text, consulta.campos, consulta.processar_status)
    
    def _processar_resposta(self, response_text: str, campos: list, processar_status: bool = False):
